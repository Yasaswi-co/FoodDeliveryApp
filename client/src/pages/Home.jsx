    ...
    <div className="HomePage">
      ...
      <div className="home-categories-container">
        ...
        <div className="home-category-card" onClick={()=>navigate('/category/Burger')}>
          <img src="https://img.freepik.com/premium-photo/homemade-burger-with-beef-cheese-onion-marmalade-wooden-board-fast-food-concept-american-food_90258-3917.jpg?semt=ais_items_boosted&w=740" alt="" />
          <h5>Burger</h5>
        </div>
